...
if ( ! function_exists( '{{theme.slugfn}}_enqueue_scripts' ) ) :
	...
	function {{theme.slugfn}}_enqueue_scripts() {
		...
		if ( file_exists( $style_path ) ) {
			wp_enqueue_style( '{{theme.slug}}-style', {{#if theme.parent}}get_theme_file_uri( $css_dir . $theme_css ){{else}}get_stylesheet_directory_uri() . $css_dir . $theme_css{{/if}}, array(), $theme_version );
		...
		if ( file_exists( $script_path ) ) {
			wp_enqueue_script( '{{theme.slug}}-script', {{#if theme.parent}}get_theme_file_uri( $js_dir . $theme_js ){{else}}get_stylesheet_directory_uri() . $js_dir . $theme_js{{/if}}, array(), $theme_version, true );
		}
