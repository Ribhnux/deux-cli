...
exports.SUCCEED_WIDGET_ADDED = 'Yay, new widget has been added to config.'
...
exports.ERROR_WIDGET_ALREADY_EXISTS = `Widget already exists. Please choose another name, type: ${chalk.bold.cyan('deux remove widget')} to remove Widget.`
