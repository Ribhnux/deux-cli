...
exports.ERROR_COMPONENT_ALREADY_EXISTS = `Component already exists. Please choose another name, type: ${chalk.bold.cyan('deux remove theme')} to remove from list.`
...
exports.ERROR_TEMPLATE_ALREADY_EXISTS = `Template already exists. Please choose another name, type: ${chalk.bold.cyan('deux remove plugin')} to remove from list.`
