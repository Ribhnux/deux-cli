...
exports.CREATE_NEW_THEME = `Please make new theme, type ${chalk.bold.cyan('deux new')} or ${chalk.bold.cyan('deux import')}`
...
exports.DONE_NO_REMOVE = 'Well, we\'ve nothing to remove.'
exports.SUCCEED_INIT_DB = 'Success init database.'
exports.SUCCEED_CREATE_NEW_THEME = 'Your new theme has been created.'
exports.SUCCEED_ALREADY_IN_CURRENT_PROJECT = 'Theme already selected as current project.'
...
exports.SUCCEED_IMPORT = 'Congrats, your theme has been imported successfully.'
exports.ERROR_INVALID_COMMAND = 'Invalid Command.'
exports.ERROR_NOT_WP_FOLDER = 'Invalid WordPress installation directory.'
exports.ERROR_NO_THEME = 'You have 0 theme in project.'
...
exports.ERROR_THEME_IMPORT_CANCELED = 'Import theme was canceled.'
...
exports.ERROR_INVALID_THEMECHECK = `Invalid WordPress Theme, type ${chalk.bold.cyan('deux test themecheck')} to see the details`
exports.ERROR_INVALID_WPCS = `Invalid WordPress Coding Standard, type ${chalk.bold.cyan('deux test wpcs')} to see the details`
...
exports.ERROR_INVALID_SOURCE = 'Invalid source.'
exports.ERROR_INVALID_THEME = 'Invalid theme.'
