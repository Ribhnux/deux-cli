...
exports.ERROR_INVALID_THEMECHECK = `Invalid theme, type: ${chalk.bold.cyan('deux test themecheck')} to see the details`
exports.ERROR_INVALID_WPCS = `Invalid WordPress coding standard, type: ${chalk.bold.cyan('deux test wpcs')} to see the details`
exports.ERROR_INVALID_W3 = `Invalid html5 theme, type: ${chalk.bold.cyan('deux test w3')} to see the details`
