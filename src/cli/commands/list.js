...
const currentProject = deuxProject.list[deuxProject.current].themeName

const getActions = () => {
  colorlog(`Action hook list in {${currentProject}}. You have a total of {0} actions.`)
}

const getAssets = () => {
  colorlog(`Assets list in {${currentProject}}. You have a total of {0} assets.`)
}

const getFilters = () => {
  colorlog(`Filter hook list in {${currentProject}}. You have a total of {0} filters.`)
}

const getPlugins = () => {
  colorlog(`Plugin list in {${currentProject}}. You have a total of {0} plugins.`)
}
...
const getTemplates = () => {
  colorlog(`PostType template list in {${currentProject}}. You have a total of {0} templates.`)
}

const getComponents = () => {
  colorlog(`Component list in {${currentProject}}. You have a total of {0} components.`)
}
